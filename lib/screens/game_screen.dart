...
class _KnightsTourCompleteOverlay extends ConsumerWidget {
  final GameSettings settings;
  
  const _KnightsTourCompleteOverlay({required this.settings});
...
class _KnightsTourFailedOverlay extends ConsumerWidget {
  final GameSettings settings;
  
  const _KnightsTourFailedOverlay({required this.settings});
